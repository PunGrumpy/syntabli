...
export const columns: ColumnDef<ColumnSchema>[] = [
  {
    ...
    cell: ({ row }) => {
      ...
      if (value) return <Check className="size-4 text-green-500/60" />
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return <TextWithTooltip className="max-w-[85px] font-mono" text={value} />
    },
    meta: {
      label: 'UUID'
    }
          ...
          >
            <dl className="flex flex-col gap-1">
              <div className="flex items-center justify-between gap-4 text-sm">
                ...
                <dd className="truncate font-mono">{date.getTime()}</dd>
              </div>
              <div className="flex items-center justify-between gap-4 text-sm">
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <TextWithTooltip className="max-w-[120px] font-mono" text={value} />
      )
    }
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <HoverCard openDelay={50} closeDelay={50}>
          ...
          <HoverCardContent side="bottom" className="z-10 w-auto p-2">
                ...
                return (
                  <div key={phase} className="grid grid-cols-2 gap-4 text-xs">
                    <div className="flex items-center gap-2">
                      <div className={cn(color, 'size-2 rounded-full')} />
