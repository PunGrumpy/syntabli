  ...
  return (
    <>
      ...
      <main className="container mx-auto flex min-h-screen flex-col gap-4 p-4 sm:p-16">
        <div className="relative mx-auto flex size-full min-h-full max-w-7xl flex-col gap-4 rounded-lg border border-border/50 bg-background/50 p-4 backdrop-blur-[2px] sm:gap-8 sm:p-8">
