  ...
  return (
    <dl {...props}>
      <div className="flex items-center justify-between gap-4 border-b py-2 text-sm">
        ...
        <dd className="truncate font-mono">{data.uuid}</dd>
      </div>
      <div className="flex items-center justify-between gap-4 border-b py-2 text-sm">
      ...
      <div className="flex items-center justify-between gap-4 border-b py-2 text-sm">
        ...
        <dd className="text-right font-mono">{formatDate(data.date)}</dd>
      </div>
      <div className="flex items-center justify-between gap-4 border-b py-2 text-sm">
      ...
      <div className="flex items-center justify-between gap-4 border-b py-2 text-sm">
        ...
        <dd className="truncate font-mono">{data.host}</dd>
      </div>
      <div className="flex items-center justify-between gap-4 border-b py-2 text-sm">
        <dt className="text-muted-foreground">Pathname</dt>
        <dd className="truncate font-mono">{data.pathname}</dd>
      </div>
      <div className="flex items-center justify-between gap-4 border-b py-2 text-sm">
      ...
      <div className="flex items-center justify-between gap-4 border-b py-2 text-sm">
        ...
        <dd>
          <HoverCard open={open} onOpenChange={setOpen}>
            ...
            <HoverCardContent className="flex w-40 flex-col gap-2 p-2 text-xs">
              <p>
      ...
      <div className="flex flex-col gap-2 border-b py-2 text-left text-sm">
        ...
        {timingPhases.map(phase => (
          ...
          >
            <div className="truncate uppercase text-muted-foreground">
      ...
      {data.message ? (
        <div className="flex flex-col gap-2 border-b py-2 text-left text-sm">
          ...
          <CopyToClipboardContainer className="whitespace-pre-wrap break-all rounded-md border border-destructive/50 bg-destructive/30 p-2 font-mono">
            {JSON.stringify(data.message, null, 2)}
          </CopyToClipboardContainer>
        </div>
      ) : null}
      <div className="flex flex-col gap-2 py-2 text-left text-sm">
        <dt className="text-muted-foreground">Headers</dt>
        <CopyToClipboardContainer className="whitespace-pre-wrap break-all rounded-md border bg-muted/50 p-2 font-mono">
